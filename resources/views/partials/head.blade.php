<head>
  ...
  <meta property="og:image" content="@php bloginfo( 'url' ) @endphp/wp-content/uploads/2020/08/djtech3.jpg">
  <meta name="description" content="San Diego based producer sp da iLL kid storefront for classic boom bap Hip-Hop. sp1200, mpc2000 and mad sample records.">
  @php wp_head() @endphp
  @if(!is_front_page()) 
